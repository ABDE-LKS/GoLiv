...
mixin _$StoreModel {
  ...
  String? get promotionLabel => throw _privateConstructorUsedError;
    ...
    return _then(_value.copyWith(
      ...
      hasPromotion: null == hasPromotion
          ...
          : hasPromotion // ignore: cast_nullable_to_non_nullable
              as bool,
      promotionLabel: freezed == promotionLabel
          ? _value.promotionLabel
          : promotionLabel // ignore: cast_nullable_to_non_nullable
              as String?,
...
class _$StoreModelImpl implements _StoreModel {
  ...
  @override
  String toString() {
    return 'StoreModel(id: $id, name: $name, category: $category, rating: $rating, reviewCount: $reviewCount, deliveryTime: $deliveryTime, deliveryFee: $deliveryFee, minimumOrder: $minimumOrder, distance: $distance, isOpen: $isOpen, isFeatured: $isFeatured, hasPromotion: $hasPromotion, promotionLabel: $promotionLabel, coverImage: $coverImage, address: $address)';
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            (identical(other.promotionLabel, promotionLabel) ||
                other.promotionLabel == promotionLabel) &&
...
abstract class _StoreModel implements StoreModel {
  const factory _StoreModel(
      ...
      required final int minimumOrder,
      ...
      required final String address}) = _$StoreModelImpl;
